...
export class CreateDatabase1698856771620 implements MigrationInterface {
    name = 'CreateDatabase1698856771620'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "realEstateld" integer NOT NULL, "userId" integer NOT NULL, "realEstatesId" integer, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "realEstates" ("id" SERIAL NOT NULL, "sold" boolean NOT NULL, "value" integer NOT NULL, "size" integer NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "addressesId" integer, "categoriesId" integer, CONSTRAINT "REL_d64118a1cb2b2b54747d5851fe" UNIQUE ("addressesId"), CONSTRAINT "PK_57badbed001c9b97de867eaa976" PRIMARY KEY ("id"))`);
